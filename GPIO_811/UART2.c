...
//------------UART_Init------------
// Initialize UART0 for 115,200 baud rate (assuming 50 MHz clock),
...
// interrupt handler for when at least one of three things has happened:
...
//------------UART_InChar------------
// Wait for new serial port input, spin if FIFO empty
// Input: none
