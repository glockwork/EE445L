...
//char UARTreturnFifo[7];
//unsigned char debugFifoIdx = 0;
// Initialize UART0
...
void UART_Init(void){
  ...
  UART1_IBRD_R = 325;                    // IBRD = int(50,000,000 / (16 * 115,200)) = int(27.1267), 27
  ...
  GPIO_PORTD_DEN_R |= 0x0C;             // enable digital I/O on PD2-3
                                        // UART0=priority 2
  NVIC_PRI1_R = (NVIC_PRI1_R&0xFF0FFFFF)|0x00400000; // bits 21-23
...
//	UARTreturnFifo[debugFifoIdx] = letter;
//	debugFifoIdx += 1;
	if(letter != FIFOFAIL){
		return 1;
	}
